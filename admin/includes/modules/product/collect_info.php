...
/**
 * @name EXTRA PRODUCT FIELDS MOD
 * @author Delia Wilson Lunsford
 * @copyright Copyright 2009 Delia Wilson Lunsford
 * @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
 * @version 1
 * 
 */
...
//eof extra fields mod
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      $product = $db->Execute("select pd.products_name, pd.products_description, pd.products_url,
                                      ...
                                      p.manufacturers_id,
                                      pe.extra_field, pe.file_1, pe.file_2, pe.file_3, pe.file_4, pe.file_1_title, pe.file_2_title, pe.file_3_title, pe.file_4_title,pe.video,pe.video_title, pe.width, pe.height, pe.text_1, pe.text_2, pe.text_3, pe.text_4, 
...
?>
 ...
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                 ...
                 <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_EXTRA_TEXT_FIELD; ?></td>
            <td class="main"><?php echo zen_draw_textarea_field('extra field', 'soft', '100%', '30', stripslashes($pInfo->extra_field));
			
			zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('extra_field',$pInfo->extra_field, 'class="noEditor"') ?></td>
          </tr>    
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
                           <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_TEXT_1; ?></td>
            <td class="main"><?php echo zen_draw_input_field('text_1', $pInfo->text_1);?></td>
          </tr>    
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
                         <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_TEXT_2; ?></td>
            <td class="main"><?php echo zen_draw_input_field('text_2', $pInfo->text_2);?></td>
          </tr>    
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
                         <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_TEXT_3; ?></td>
            <td class="main"><?php echo zen_draw_input_field('text_3', $pInfo->text_3);?></td>
          </tr>    
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_TEXT_4; ?></td>
            <td class="main"><?php echo zen_draw_input_field('text_4', $pInfo->text_4); ?>
			</td>
          </tr>    
 <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          ...
          <tr>
            ...
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('file_1') .  '&nbsp;'. TEXT_PRODUCTS_FILE_DESCRIPTION . ' ' . zen_draw_input_field('file_1_title', $pInfo->file_1_title) . zen_draw_hidden_field('previous_file_1', $pInfo->file_1).' '.$pInfo->file_1; ?></td>
          </tr>
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_DESCRIPTION_FILE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('file_2') .  '&nbsp;'. TEXT_PRODUCTS_FILE_DESCRIPTION . ' ' . zen_draw_input_field('file_2_title', $pInfo->file_2_title) . zen_draw_hidden_field('previous_file_2', $pInfo->file_2).' '.$pInfo->file_2 ; ?></td>
          </tr>
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_DESCRIPTION_FILE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('file_3') .  '&nbsp;'. TEXT_PRODUCTS_FILE_DESCRIPTION . ' ' . zen_draw_input_field('file_3_title', $pInfo->file_3_title) . zen_draw_hidden_field('previous_file_3', $pInfo->file_3).' '.$pInfo->file_3 ; ?></td>
          </tr>
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_DESCRIPTION_FILE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_file_field('file_4') .  '&nbsp;'. TEXT_PRODUCTS_FILE_DESCRIPTION . ' ' . zen_draw_input_field('file_4_title', $pInfo->file_4_title) . zen_draw_hidden_field('previous_file_4', $pInfo->file_4).' '.$pInfo->file_4 ; ?></td>
          </tr>
