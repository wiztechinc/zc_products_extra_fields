  ...
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $product = $db->Execute("select p.products_id, pd.language_id, pd.products_name,
                                      ...
                                      pe.extra_field, pe.file_1, pe.file_2, pe.file_3, pe.file_4, pe.file_1_title, pe.file_2_title, pe.file_3_title, pe.file_4_title, pe.video, pe.video_title, pe.text_1, pe.text_2, pe.text_3, pe.text_4, 
...
//TABLE_PRODUCT_EXTRA_FIELDS added for that mod (line 29)
...
//auto replace with defined missing image
      ...
      <?php //extra products fields mod ?>
         <tr> <td>
	  <?php echo $pInfo->extra_field ; ?>
	  </td></tr>
      <tr> <td>
	  <?php echo TEXT_PRODUCTS_TEXT_1 . ': '.$pInfo->text_1 ; ?>
	  </td></tr>
      <tr> <td>
	  <?php echo TEXT_PRODUCTS_TEXT_2 . ': '.$pInfo->text_2 ; ?>
	  </td></tr>
      <tr> <td>
	  <?php echo TEXT_PRODUCTS_TEXT_3 . ': '.$pInfo->text_3 ; ?>
	  </td></tr>
      <tr> <td>
	  <?php echo TEXT_PRODUCTS_TEXT_4 . ': '.$pInfo->text_4 ; ?>
	  </td></tr>
      <tr>
      <tr> <td>
	  <?php echo "<a href='products_extra_files/flash.php?id=" .  $_GET['pID'] . "'>" . $pInfo->video_title . "</a>";
	  echo $products_video_name ?>
	  </td></tr>
      <tr>
          <td style="font-weight: bold;"><?php echo TEXT_PRODUCTS_DESCRIPTION_FILE; ?></td>
      </tr>
      <tr>
          <td>
            <?php echo "<a href='products_extra_files/" . $products_file_1_name . "'>" . $pInfo->file_1_title . "</a>"; ?>
          </td>
      </tr>
      <tr>
          <td>
            <?php echo "<a href='products_extra_files/" . $products_file_2_name . "'>" . $pInfo->file_2_title . "</a>"; ?>
          </td>
      </tr>
      <tr>
          <td>
            <?php echo "<a href='products_extra_files/" . $products_file_3_name . "'>" . $pInfo->file_3_title . "</a>"; ?>
          </td>
      </tr>
      <tr>
          <td>
            <?php echo "<a href='products_extra_files/" . $products_file_4_name . "'>" . $pInfo->file_4_title . "</a>"; ?>
          </td>
      </tr>
      <?php // eof extra products fields mod ?>
<?php
